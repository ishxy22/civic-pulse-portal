    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <Button className="bg-gradient-primary hover:shadow-glow transition-all duration-300" onClick={createIssue} disabled={isCreating || !user}>
              ...
              <CardContent className="p-6">
                ...
                <div className="flex items-center justify-between pt-4 border-t">
                  ...
                  <div className="flex gap-2">
                    ...
                    {user?.role === 'admin' && issue.status === 'acknowledged' && (
                    ...
                    {user?.role === 'admin' && issue.status === 'in_progress' && (
